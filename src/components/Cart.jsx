              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-shrink-0">
                    {item.customization?.finalRender || item.customization?.aiRendering ? (
                      <img
                        src={item.customization.finalRender || item.customization.aiRendering}
                        alt="Custom Gold Bar"
                      ...
                      <div className="mt-2 text-sm text-gray-600">
                        ...
                        {(item.customization.finalRender || item.customization.aiRendering) && (
                          <div className="flex items-center space-x-2 text-green-600">
                            <span className="font-medium">✓ Custom Preview Available</span>
                          </div>
                        )}
                      </div>
                    )}
