...
const { 
  FiShoppingCart, FiDownload, FiArrowLeft, FiZap, FiBrain, 
  FiImage, FiCheck, FiStar, FiEye
} = FiIcons;

const AIRenderingPreview = ({ aiResult, customText, logoImage, onBack }) => {
  ...
  const baseProduct = {
    ...
    name: 'AI-Rendered Custom Gold Bar',
    price: 599.99
  };
  ...
  const handleAddToCart = () => {
    ...
    alert('AI-rendered custom gold bar added to cart!');
  };
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.download = `ai-rendered-gold-bar-${Date.now()}.png`;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
            Step 3: AI-Generated Photorealistic Preview
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Your custom gold bar rendered with {customText ? 'Imagic' : 'ControlCom'} AI technology
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              {aiResult?.imageData ? (
                <div className="relative">
                  <img 
                    ...
                    alt="AI-rendered custom gold bar"
            ...
            <div className="p-4 bg-purple-50 border-t">
              <div className="flex items-center justify-between text-sm mb-3">
                <div className="flex items-center space-x-2 text-purple-700">
                  ...
                  <span>{aiResult?.metadata?.model || 'AI Model'}</span>
                </div>
              ...
              {aiResult?.metadata && (
                <div className="text-xs text-purple-600 space-y-1">
                  ...
                  <p>✓ {aiResult.metadata.technique || 'Advanced AI rendering'}</p>
          ...
          >
            <h3 className="text-lg font-semibold mb-4 flex items-center">
              <SafeIcon icon={FiEye} className="w-5 h-5 mr-2 text-gold-600" />
              AI Rendering Complete
            </h3>

            {/* Content Summary */}
            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
              <h4 className="font-medium text-gray-800 mb-2">Rendering Summary</h4>
...
export default AIRenderingPreview;